...
contract MESH is StandardToken {
    ...
    function transferProxy(address _from, address _to, uint256 _value, uint256 _fee,
        ...
        // require(_from ==ecrecover(h,_v,_r,_s),"Error3");
    ...
    function hashMessage(address _from , address _to,uint value,uint fee,uint nonce) public pure returns(bytes32){
        return keccak256(_from,_to,value,fee,nonce);
    }
}